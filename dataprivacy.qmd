...
Im Folgenden informieren wir über die Verarbeitung personenbezogener Daten bei der Nutzung unserer Website www.clsfoundation.org und unserer Profile in Sozialen Medien.
...
Verantwortlicher gem. Art. 4 Abs. 7 EU-Datenschutz-Grundverordnung (DSGVO) ist die Computational Life Sciences Foundation gUG, Am Sportplatz 7, 26683 Saterland, Deutschland, E-Mail: info@clsfoundation.org. Gesetzlich vertreten werden wir durch Dr. Stephan Schaller.

Unser Datenschutzbeauftragter ist Dr. Stephan Schaller, über E-Mail: info@clsfoundation.org erreichbar.
...
Unsere Website hostet Ionos. Anbieter ist 1&1 IONOS SE, Elgendorfer Str. 57, 56410 Montabaur. Der Anbieter verarbeitet dabei die über die Website übermittelten personenbezogenen Daten, z.B. Inhalts-, Nutzungs-, Meta-/Kommunikationsdaten oder Kontaktdaten, in der EU. Weitere Informationen finden sich in der Datenschutzerklärung des Anbieters unter https://www.ionos.co.uk/terms-gtc/privacy-policy/#c4183.
...
Wir nutzen das Content Delivery Network shopify für unsere Website. Anbieter ist Shopify International Limited, Victoria Buildings, 2. Etage, 1-2 Haddington Road, Dublin 4, D04 XN32, Irland. Der Anbieter verarbeitet dabei die über die Website übermittelten personenbezogenen Daten, z.B. Inhalts-, Nutzungs-, Meta-/Kommunikations- oder Kontaktdaten in der EU. Weitere Informationen finden Sie in der Datenschutzerklärung des Anbieters unter https://www.shopify.de/legal/datenschutz.
...
Wir nutzen EU Survey, um Umfragen im Bereich der Forschung durchzuführen. Der Anbieter ist die Abteilung für Informatik der EU-

Kommission (DG DIGIT). Der Anbieter verarbeitet Umfragedaten (z. B. Stammdaten, IP-Adresse, gegebene Antworten) in der EU.

Die Rechtsgrundlage der Verarbeitung ist Art. 6 Abs. 1 S. 1 lit. a DSGVO. Die Verarbeitung erfolgt auf der Basis von Einwilligungen. Betroffene können ihre Einwilligung jederzeit widerrufen, indem sie uns z.B. unter den in unserer Datenschutzerklärung angegebenen Kontaktdaten kontaktieren. Der Widerruf berührt nicht die Rechtmäßigkeit der Verarbeitung bis zum Widerruf.

Die Daten werden gelöscht, wenn der Zweck ihrer Erhebung entfallen ist und keine Aufbewahrungspflicht entgegensteht. Weitere Informationen sind in der Datenschutzerklärung des Anbieters unter https://commission.europa.eu/privacy-policy-websites-managed-european-commission_en abrufbar.

### 3.8. Datenverarbeitung für das Angebot von Schulungen

Auf unserer Website können Nutzer/innen Schulungen für die Software PK-Sim® und MoBi® buchen. Dabei verarbeiten wir die folgenden personenbezogenen Daten:

IP-Adresse
Vor- und Nachname
Telefonnummer
E-Mail Adresse
Zugehörigkeit (Arbeitgeber, Universität, etc.)
Für das Angebot von Online-Schulungen nutzen wir die Software TalentLMS. Der Anbieter ist Epignosis LLC, 315 Montgomery Street, San Francisco, CA 94104, USA. Der Anbieter verarbeitet Verbindungsdaten (IP-Adressen, Logdaten) in den USA.

Die Verarbeitung der personenbezogenen Daten erfolgt auf der Grundlage von Art. 6 Abs. 1 lit. b DSGVO. Die Verarbeitung ist notwendig, um die Schulung anbieten zu können.

Die Rechtsgrundlage für die Übermittlung in ein Land außerhalb des EWR sind Standardvertragsklauseln. Die Sicherheit der in das Drittland (d.h. ein Land außerhalb des EWR) übermittelten Daten wird durch Standarddatenschutzklauseln (Art. 46 Abs. 2 lit. c DSGVO) gewährleistet, die von der EU-Kommission im Rahmen des Prüfverfahrens nach Art. 93 Abs. 2 DSGVO, dem wir mit dem Anbieter zugestimmt haben.

Bei Schulungen, die vor Ort stattfinden, können wir freiwillige Informationen wie z. B. Ernährungsbedürfnisse erfragen, um das vor Ort angebotene Buffet anzupassen. Für freiwillige Informationen ist die Rechtsgrundlage für die Verarbeitung Art. 6 Abs. 1 lit. a DSGVO. Betroffene Personen können ihre Einwilligung jederzeit widerrufen, indem sie uns z. B. über die in unserer Datenschutzerklärung angegebenen Kontaktdaten kontaktieren. Der Widerruf hat keinen Einfluss auf die Rechtmäßigkeit der Verarbeitung bis zum Widerruf.
...
```{=html}
<h1 id="data-privacy-english-section" class="display-6 fw-normal text-center mt-5"></h1>
```
...
our website www.esqlabs.com
our profiles in social media.
Personal data is any data that can be related to a specific natural person, such as their name or IP address.

### 1.1. Contact details

The controller within the meaning of Art. 4 para. 7 EU General Data Protection Regulation (GDPR) is Computational Life Sciences Foundation gUG, Am Sportplatz 7, Hambierich 34, 26683 Saterland, Germany, email: info@clsfoundation.org. We are legally represented by Dr. Stephan Schaller.

Our data protection officer is Dr. Stephan Schaller, E-Mail: info@clsfoundation.org.
...
We use the content delivery network shopify for our website. The provider is Shopify International Limited, Victoria Buildings, 2. Etage, 1-2 Haddington Road, Dublin 4, D04 XN32, Ireland. The provider thereby processes the personal data transmitted via the website, e.g. content, usage, meta/communication data or contact data in the EU. Further information can be found in the provider’s privacy policy at https://www.shopify.com/legal/privacy.
...
We use EU Survey to conduct surveys in the field of research. The provider is The EU Commission’s department for informatics (DG DIGIT). The provider processes survey data (e.g. master data, IP-address, answers given) in the EU.

The legal basis for the processing is Art. 6 para. 1 s. 1 lit. a GDPR. The processing is based on consent. Data subjects may revoke their consent at any time by contacting us, for example, using the contact details provided in our privacy policy. The revocation does not affect the lawfulness of the processing until the revocation.

The data will be deleted when the purpose for which it was collected no longer applies and there is no obligation to retain it. Further information is available in the provider’s privacy policy at https://commission.europa.eu/privacy-policy-websites-managed-european-commission_en.

### 3.8. Data processing for the offering of training

On our website, users can book training for the software PK-Sim® and MoBi®. We thereby process the following personal data:

IP-Adress
First and last name
Phone number
E-Mail Address
Affiliation (employer, university, etc)
For the offering of online training, we use the software TalentLMS. The provider is ​Epignosis LLC, 315 Montgomery Street, San Francisco, CA 94104, USA​. The provider processes connection data (IP addresses, log data) in the USA.

The processing of personal data takes place on the basis of Art. 6(1)(b) GDPR. The processing is necessary for offering the training.

The legal basis for the transfer to a country outside the EEA are standard contractual clauses. The security of the data transferred to the third country (i.e. a country outside the EEA) is guaranteed by standard data protection clauses (Art. 46 para. 2 lit. c GDPR) adopted by the EU Commission in accordance with the examination procedure under Art. 93 para. 2 of the GDPR, which we have agreed to with the provider.

For training courses that take place on-site, we might ask for optional information such as nutrition requirements to adjust the on-site buffet that is offered. For optional information, the legal basis for the processing is Art. 6 (1)(a) GDPR. Data subjects may revoke their consent at any time by contacting us, for example, using the contact details provided in our privacy policy. The revocation does not affect the lawfulness of the processing until the revocation.
